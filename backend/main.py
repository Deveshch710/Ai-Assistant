...
from api import assistant, user, nlp, tts ,vision, face_recognition # Import the new NLP API
...
app.include_router(face_recognition.router, prefix="/face_recognition", tags=["Face Recognition"])  # Add Face Recognition API
